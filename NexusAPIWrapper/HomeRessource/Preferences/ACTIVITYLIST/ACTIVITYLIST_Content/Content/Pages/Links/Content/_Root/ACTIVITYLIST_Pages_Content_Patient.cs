...
namespace NexusAPIWrapper{ 
    ...
    public class ACTIVITYLIST_Pages_Content_Patient
    {
        [JsonProperty("id")]
        public int? Id;
        ...
        public ACTIVITYLIST_Pages_Content_PatientIdentifier PatientIdentifier;

        [JsonProperty("currentAddress")]
        public ACTIVITYLIST_Pages_Content_CurrentAddress CurrentAddress;
        ...
        public ACTIVITYLIST_Pages_Content_PatientState PatientState;
