...
namespace NexusAPIWrapper{ 
    ...
    public class PatientGrantByIdSelf_Patient
    {
        [JsonProperty("id")]
        public int? Id;
        ...
        public PatientGrantByIdSelf_PatientIdentifier PatientIdentifier;

        [JsonProperty("currentAddress")]
        public PatientGrantByIdSelf_CurrentAddress CurrentAddress;
        ...
        public PatientGrantByIdSelf_PatientState PatientState;
