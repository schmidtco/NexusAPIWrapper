...
namespace NexusAPIWrapper{ 
    ...
    public class AvCondClassCondPrototype_Patient
    {
        [JsonProperty("id")]
        public int? Id;
        ...
        public AvCondClassCondPrototype_PatientIdentifier PatientIdentifier;

        [JsonProperty("currentAddress")]
        public AvCondClassCondPrototype_CurrentAddress CurrentAddress;
        ...
        public AvCondClassCondPrototype_PatientState PatientState;
