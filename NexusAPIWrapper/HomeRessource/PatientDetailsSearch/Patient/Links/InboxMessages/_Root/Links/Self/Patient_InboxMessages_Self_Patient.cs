...
namespace NexusAPIWrapper{ 
    ...
    public class Patient_InboxMessages_Self_Patient
    {
        [JsonProperty("id")]
        public int? Id;
        ...
        public Patient_InboxMessages_Self_PatientIdentifier PatientIdentifier;

        [JsonProperty("currentAddress")]
        public Patient_InboxMessages_Self_CurrentAddress CurrentAddress;
        ...
        public Patient_InboxMessages_Self_PatientState PatientState;
