...
namespace NexusAPIWrapper{ 
    ...
    public class PatCond_RelActi_Patient
    {
        [JsonProperty("id")]
        public int? Id;
        ...
        public PatCond_RelActi_PatientIdentifier PatientIdentifier;

        [JsonProperty("currentAddress")]
        public PatCond_RelActi_CurrentAddress CurrentAddress;
        ...
        public PatCond_RelActi_PatientState PatientState;
