...
namespace NexusAPIWrapper{ 
    ...
    public class PatCond_Observ_Patient
    {
        [JsonProperty("id")]
        public int? Id;
        ...
        public PatCond_Observ_PatientIdentifier PatientIdentifier;

        [JsonProperty("currentAddress")]
        public PatCond_Observ_CurrentAddress CurrentAddress;
        ...
        public PatCond_Observ_PatientState PatientState;
