...
namespace NexusAPIWrapper{ 
    ...
    public class PatientEnrolled_Patient
    {
        [JsonProperty("id")]
        public int? Id;
        ...
        public PatientEnrolled_PatientIdentifier PatientIdentifier;

        [JsonProperty("currentAddress")]
        public PatientEnrolled_CurrentAddress CurrentAddress;
        ...
        public PatientEnrolled_PatientState PatientState;
