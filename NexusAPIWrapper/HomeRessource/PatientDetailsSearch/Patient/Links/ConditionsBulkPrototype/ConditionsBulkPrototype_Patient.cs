...
namespace NexusAPIWrapper{ 
    ...
    public class ConditionsBulkPrototype_Patient
    {
        [JsonProperty("id")]
        public int? Id;
        ...
        public PatCond_RelActiWHist_PatientIdentifier PatientIdentifier;

        [JsonProperty("currentAddress")]
        public ConditionsBulkPrototype_CurrentAddress CurrentAddress;
        ...
        public ConditionsBulkPrototype_PatientState PatientState;
